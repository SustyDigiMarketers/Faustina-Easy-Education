        ...
        <section className="py-32 bg-white relative overflow-hidden" id="testimonials">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                    <div>
                        <div className="inline-block p-4 bg-blue-600 rounded-3xl shadow-2xl shadow-blue-500/30 mb-10 animate-float">
                        ...
                        <h2 className="text-5xl md:text-7xl font-black text-slate-900 leading-[0.95] tracking-tighter mb-10">
                            Echoes of <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Our Visionaries.</span>
                        </h2>
                            ...
                            {testimonialsData.map((_, index) => (
                                <button
                                    ...
                                    className={`h-2 rounded-full transition-all duration-700 ${
                                        currentIndex === index ? 'w-12 bg-blue-600' : 'w-3 bg-slate-200 hover:bg-slate-300'
                                    }`}
                    ...
                    <div className="relative">
                        <div className="absolute -top-16 -right-16 w-32 h-32 bg-yellow-400 rounded-full blur-[80px] opacity-20 animate-pulse"></div>
                                ...
                                >
                                    ...
                                    <div className="flex items-center space-x-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-bold text-blue-600 uppercase tracking-widest">{testimonialsData[currentIndex].role}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
