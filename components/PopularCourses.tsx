...
const PopularCourses: React.FC<PopularCoursesProps> = ({ courses }) => {
    ...
    return (
        <section className="bg-slate-50/50 py-32 relative overflow-hidden" id="courses">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.05)_0%,_transparent_70%)] pointer-events-none"></div>

            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row items-end justify-between mb-20 gap-8">
                    <div className="max-w-3xl">
                        <div className="inline-block px-4 py-1.5 rounded-full bg-blue-50 text-blue-600 font-black text-[10px] uppercase tracking-[0.3em] mb-6 animate-float">
                            Academic Excellence
                        </div>
                        <h2 className="text-5xl md:text-7xl font-black text-slate-900 leading-[0.95] tracking-tighter mb-6">
                            Master the Skills of <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">The Future.</span>
                        </h2>
