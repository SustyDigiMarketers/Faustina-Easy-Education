...
const categoryDetails: { [key: string]: { icon: React.ReactElement, color: string } } = {
    ...
    'Phonics & English Communication': { icon: <WritingIcon className="w-8 h-8 sm:w-10 sm:h-10"/>, color: 'bg-blue-100 text-blue-500' },
    'Robotics & Coding': { icon: <ProgrammingIcon className="w-8 h-8 sm:w-10 sm:h-10"/>, color: 'bg-red-100 text-red-500' },
    'Computer Hardware & IT Skills': { icon: <LaptopIcon className="w-8 h-8 sm:w-10 sm:h-10"/>, color: 'bg-green-100 text-green-500' },
    'Commerce & Accounts': { icon: <AccountingIcon className="w-8 h-8 sm:w-10 sm:h-10"/>, color: 'bg-green-100 text-green-500' },
...
const HowItWorksSection: React.FC = () => {
    ...
    return (
        <section className="bg-white py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <p className="text-blue-600 font-semibold mb-2">EASY PROCESS</p>
