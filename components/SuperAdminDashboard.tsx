...
import { GalleryImage, BlogPost, Page } from '../types';
...
const SuperAdminDashboard: React.FC<SuperAdminDashboardProps> = (props) => {
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-slate-50">
            {/* Sidebar - Fixed Height, overflow-y-hidden ensures it NEVER scrolls */}
            ...
            {/* Main Content - overflow-y-auto ensures ONLY this area scrolls */}
