...
import { GalleryImage, BlogPost, Page } from '../App';
...
type Tab = 'gallery' | 'blogs' | 'courses';
            ...
            <aside className="w-64 bg-gray-800 text-white flex flex-col p-4 flex-shrink-0">
                <button onClick={() => props.navigate('home')} className="flex items-center space-x-3 p-2 mb-8 rounded-lg hover:bg-gray-700 transition-colors">
                    ...
                    <div>
                        ...
                        <span className="text-xs text-gray-400 block leading-tight">Eduker University</span>
                    </div>
                </button>
                ...
                <div className="mt-auto">
                    <button 
                        ...
                        className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors duration-200 text-gray-300 hover:bg-gray-700 hover:text-white mb-2"
                    >
                    ...
                    <button
                        ...
                        className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors duration-200 bg-red-600/20 text-red-300 hover:bg-red-600 hover:text-white"
                    >
