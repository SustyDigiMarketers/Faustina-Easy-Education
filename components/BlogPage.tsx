    ...
    <aside className="space-y-8">
        ...
        <div className="p-6 bg-slate-50 rounded-lg">
            ...
            <ul className="space-y-2 text-gray-600">
                ...
                <li className="flex justify-between items-center"><a href="#" className="hover:text-blue-600">Campus Events</a> <span>(0)</span></li>
                <li className="flex justify-between items-center"><a href="#" className="hover:text-blue-600">Career</a> <span>(0)</span></li>
